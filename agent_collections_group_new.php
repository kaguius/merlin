...
if ($adminstatus == 4) {
    ...
    if (!empty($_GET)) {
        $agent = $_GET['agent'];
        // Limit report start date to 31st August, 2015
                ...
                <div class="post">
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example">
                        ...
                        <tbody>
                            ...
                            while ($row = mysql_fetch_array($sql_field_agent)) {
                                ...
                                //$sql = mysql_query("select distinct loan_application.collections_agent, loan_rep_date, loan_rep_code, sum(loan_rep_amount)loan_rep_amount from loan_repayments inner join loan_application on loan_application.loan_code = loan_repayments.loan_rep_code where loan_rep_date between '$current_date' and '$current_date' and collections_agent != '' group by collections_agent");
                                $sql_get_payments = mysql_query("select distinct lr.current_collector,lr.loan_rep_date, lr.loan_rep_code, sum(lr.loan_rep_amount)loan_rep_amount from loan_repayments lr inner join loan_application l on l.loan_code = lr.loan_rep_code where lr.loan_rep_date = '$current_date' and lr.current_collector = '$field_agent'");
                                while ($row = mysql_fetch_array($sql_get_payments)) {
                                    $intcount++;
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example">
                        ...
                        <tbody>
                            ...
                            while ($row = mysql_fetch_array($sql_edc)) {
                                ...
                                $sql_get_payments = mysql_query("select distinct lr.current_collector,lr.loan_rep_date, lr.loan_rep_code, sum(lr.loan_rep_amount)loan_rep_amount from loan_repayments lr inner join loan_application l on l.loan_code = lr.loan_rep_code where lr.loan_rep_date = '$current_date' and lr.current_collector = '$edc'");
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example2">
                        ...
                        <tbody>
                            <?php
                            $intcount = 0;
                            $total_loan_rep_monthly_amount_cc = 0;
                            $loan_rep_amount_monthly_cc = 0;
                            ...
                            while ($row = mysql_fetch_array($sql_collections_agent)) {
                                ...
                                while ($row = mysql_fetch_array($sql_get_payments)) {
                                    ...
                                    $loan_rep_amount_monthly_cc = $row['loan_rep_amount'];
                                    ...
                                    echo "<td valign='top'>$intcount.</td>";
                                    echo "<td valign='top'>$collections_agent_name</td>";
                                    echo "<td align='right' valign='top'>" . number_format($loan_rep_amount_monthly_cc, 2) . "</td>";
                                    echo "</tr>";

                                    $total_loan_rep_monthly_amount_cc = $total_loan_rep_monthly_amount_cc + $loan_rep_amount_monthly_cc;
                                }
                            }
                            ?>
                        </tbody>
                        <tr bgcolor = '#E6EEEE'>
                            <td colspan='2'><strong>&nbsp;</strong></td>
                            <td align='right' valign='top'><strong><?php echo number_format($total_loan_rep_monthly_amount_cc, 2) ?></strong></td>
                        </tr>
                    </table>
                    <br />
                    <br />
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example">
                        ...
                        <tbody>
                            <?php
                            $intcount = 0;
                            $total_loan_rep_monthly_amount_fa = 0;
                            $loan_rep_monthly_amount_fa = 0;
                            ...
                            while ($row = mysql_fetch_array($sql_field_agent)) {
                                ...
                                while ($row = mysql_fetch_array($sql_get_payments)) {
                                    ...
                                    $loan_rep_monthly_amount_fa = $row['loan_rep_amount'];
                                    ...
                                    echo "<td valign='top'>$intcount.</td>";
                                    echo "<td valign='top'>$field_agent_name</td>";
                                    echo "<td align='right' valign='top'>" . number_format($loan_rep_monthly_amount_fa, 2) . "</td>";
                                    echo "</tr>";

                                    $total_loan_rep_monthly_amount_fa = $total_loan_rep_monthly_amount_fa + $loan_rep_monthly_amount_fa;
                                }
                            }
                            ?>
                        </tbody>
                        <tr bgcolor = '#E6EEEE'>
                            <td colspan='2'><strong>&nbsp;</strong></td>
                            <td align='right' valign='top'><strong><?php echo number_format($total_loan_rep_monthly_amount_fa, 2) ?></strong></td>
                        </tr>
                    </table>
                    <br />
                    <br />
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example2">
                        ...
                        <tbody>
                            <?php
                            $intcount = 0;
                            $total_loan_rep_monthly_amount_edc = 0;
                            $loan_rep_monthly_amount_edc = 0;
                            $sql_edc = mysql_query("select id, first_name, last_name from user_profiles where title = 9 and user_status = 1");
                            while ($row = mysql_fetch_array($sql_edc)) {
                                $edc = $row['id'];
                                $first_name = $row['first_name'];
                                ...
                                while ($row = mysql_fetch_array($sql_get_payments)) {
                                    $intcount++;
                                    $loan_rep_monthly_amount_edc = $row['loan_rep_amount'];
                                    $edc_name = $first_name . ' ' . $last_name;
                                    ...
                                    echo "<td valign='top'>$intcount.</td>";
                                    echo "<td valign='top'>$edc_name</td>";
                                    echo "<td align='right' valign='top'>" . number_format($loan_rep_monthly_amount_edc, 2) . "</td>";
                                    echo "</tr>";

                                    $total_loan_rep_monthly_amount_edc = $total_loan_rep_monthly_amount_edc + $loan_rep_monthly_amount_edc;
                                }
                            }
                            ?>
                        </tbody>
                        <tr bgcolor = '#E6EEEE'>
                            <td colspan='2'><strong>&nbsp;</strong></td>
                            <td align='right' valign='top'><strong><?php echo number_format($total_loan_rep_monthly_amount_edc, 2) ?></strong></td>
                        </tr>
                    </table>
                    <br />
