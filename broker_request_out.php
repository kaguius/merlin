<?php
	...
	$days = 30;
	$loan_term = $days;
//	if ($current_date >= '2015-11-17' && $current_date <= '2015-12-04'){
//		$loan_due_date = '2015-12-16';
//	}
//	else{
...
//	}
	...
	echo $loan_code." - ".$status_code." - ".$mpesa_code." - ".$loan_date." - ".$loan_due_date;
	echo "<br />";
	
	$sql = mysql_query("select loan_code from incoming_safaricom_responces where loan_code = 'loan_code'");
	...
	if($exists_loan_code == $loan_code){
		$sql3="update incoming_safaricom_responces set loan_date = '$loan_date', status_code='$status_code', mpesa_code='$mpesa_code', transactiontime = '$transactiontime', result= '$server_result' WHERE loan_code  = '$loan_code'";
		//echo $sql3."<br />";
		$result = mysql_query($sql3);
	}
	else{
		$sql3="INSERT INTO incoming_safaricom_responces (loan_date, loan_code, status_code, mpesa_code, result, transactiontime) VALUES ('$loan_date', '$loan_code', '$status_code', '$mpesa_code', '$server_result', '$transactiontime')";
		//echo $sql3."<br />";
		$result = mysql_query($sql3);
	}
	...
	if($status_code == '0'){
		...
		$sql6="update loan_application set loan_date = '$loan_date', loan_due_date='$loan_due_date', loan_mpesa_code='$mpesa_code', loan_status = '2', loan_failure_status = '$status_code' WHERE loan_code  = '$loan_code'";
		...
		if($msg == '0'){				
			$message_text = "We have disbursed ".number_format($loan_amount, 0).". Your due date is ".$loan_due_date." and the amount due is ".number_format($loan_total_interest, 0).". Your loan ref: ".$loan_code.". Kopa UPIA, kuza biashara.";
