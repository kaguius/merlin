						...
						while ($row = mysql_fetch_array($sql10))
						{
                            ...
                            $sql = mysql_query("select loan_id, customer_id, customer_station, loan_date, loan_due_date, loan_mobile, initiation_fee, loan_amount, loan_extension, loan_interest, loan_late_interest, waiver, admin_fee, appointment_fee, early_settlement, early_settlement_surplus, fix, joining_fee, loan_total_interest, loan_code, loan_mpesa_code, loan_failure_status, loan_status from loan_application where loan_code = '$confirm_loan_code' order by loan_date asc");
                             ...
                             while ($row = mysql_fetch_array($sql))
                             {
                                ...
                                $sql2 = mysql_query("select sum(loan_rep_amount)repayments from loan_repayments where loan_rep_code = '$confirm_loan_code' group by loan_rep_code");
                                while ($row = mysql_fetch_array($sql2)) {
                                ...
                                $sql2 = mysql_query("select loan_rep_date from loan_repayments where loan_rep_code = '$confirm_loan_code' order by loan_rep_date desc limit 1");
                                while ($row = mysql_fetch_array($sql2)) {
                                ...
                                echo "<td valign='top'>$write_off_date</td>";
                                ...
                                echo "</tr>";
                                //$sql3 = mysql_query("select loan_rep_date, loan_rep_amount from loan_repayments where loan_rep_code = '$confirm_loan_code'");
