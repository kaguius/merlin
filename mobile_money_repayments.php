<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "Mobile Money Reconciliation: Loan Repayments";
		include_once('includes/header.php');
		$filter_clerk = 0;
		if (!empty($_GET)){	
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<?php
						if($station == '3'){
							$sql = mysql_query("select loan_rep_id, loan_rep_date, customer_id, customer_station, loan_rep_mobile, loan_rep_amount, loan_rep_mpesa_code, loan_rep_code from loan_repayments where loan_rep_date between '$filter_start_date' and '$filter_end_date' order by loan_rep_date asc");
						}
						else{
							$sql = mysql_query("select loan_rep_id, loan_rep_date, customer_id, customer_station, loan_rep_mobile, loan_rep_amount, loan_rep_mpesa_code, loan_rep_code from loan_repayments where loan_rep_date between '$filter_start_date' and '$filter_end_date' and customer_station = '$station' order by loan_rep_date asc");
						}
