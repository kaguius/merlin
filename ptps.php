    ...
    <div id="page">
        <div id="content">
            <div class="post">
                ...
                Select a Report: <a href="ptps.php?report_title=due_today">PTPs due today</a> | <a href="ptps.php?report_title=due_tomorrow">PTPs due tomorrow</a> | <a href="ptps.php?report_title=honoured">PTPs honoured</a> | <a href="ptps.php?report_title=broken">PTPs broken | <a href="ptps.php?report_title=duration">PTPs Listing per Period</a>
                <?php if ($report_title == 'due_today') { ?>
                    <h3>PTPs Due Today</h3>
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example">
                        ...
                        <tbody>
                            ...
                            if ($station == '3' || $userid == '31') {
                                $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no, vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$current_date' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                            } else if ($station == '4') {
                                $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no, vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$current_date' and promise_to_pay.UID = '$userid' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                            } else {
                                if ($title == '3') {
                                    $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no,  vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$current_date' and users.stations = '$station' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                                } else {
                                    $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no,  vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$current_date' and users.stations = '$station' and promise_to_pay.UID = '$userid' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                                }
                            }
                            $intcount = 0;
                ...
                <?php } else if ($report_title == 'due_tomorrow') { ?>
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="example">
                        ...
                        <tbody>
                            <?php
                            if ($station == '3' || $userid == '31') {
                                $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no,  vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$tomorrow_date' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                            } else if ($station == '4') {
                                $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no,  vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$tomorrow_date' and customer_id != '0' and promise_to_pay.UID = '$userid' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                            } else {
                                if ($title == '3') {
                                    $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no,  vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$tomorrow_date' and users.stations = '$station' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                                } else {
                                    $sql = mysql_query("select promise_to_pay.id, loan_code, users.mobile_no,  vintage, overdue_days, customer_id, loan_balance, pay_date, comments, call_outcome, promise_to_pay.transactiontime, promise_to_pay.UID, users.stations from promise_to_pay inner join users on promise_to_pay.customer_id = users.id where pay_date = '$tomorrow_date' and users.stations = '$station' and promise_to_pay.UID = '$userid' and customer_id != '0' and category = 'Promise to Pay' order by promise_to_pay.id asc");
                                }
                            }
                            $intcount = 0;
                            while ($row = mysql_fetch_array($sql)) {
