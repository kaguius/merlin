	...
	if($adminstatus == 4){
		...
		if (!empty($_GET)){	
			...
			$filter_end_date = $_GET['report_end_date'];
                        ...
                        $filter_end_date = date('Y-m-d H:i:s', strtotime(str_replace('-', '/', $filter_end_date)));
                        
                      // $limit_date = "2015-07-15 23:59:59";
                        
                       // if ( $filter_end_date > $limit_date) {
                       //     $filter_end_date = $limit_date;
