		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<tbody>
					<?php
						$sql = mysql_query("select loan_id, loan_code, customer_id, customer_station, loan_mobile, loan_date, loan_due_date, loan_total_interest, late_status, collections_agent, current_collector, vintage, arrears_assigned from loan_application where late_status != 0 and late_status != '1' and collections_agent != '0' and Loan_status != '13' and loan_due_date !='' group by loan_code order by arrears_assigned desc");
						 $intcount = 0;
