					...
					<table width="108%" border="0" cellspacing="2" cellpadding="2" class="display">
						...
						<td width="36%" valign="top">
							...
							<table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="exampl">
								...
								<?php
									//if($station == '3'){
										$sql = mysql_query("select distinct loan_rep_date, sum(loan_rep_amount)repayments, count(loan_rep_id)repays, customer_station from loan_repayments where loan_rep_date between '$filter_start_date' and '$filter_end_date' and customer_station != '0' group by customer_station order by customer_station asc");
						...
						<td width="36%" valign="top">
							...
							<table width="100%" border="0" cellspacing="2" cellpadding="2" class="display" id="exampl">
								...
								<?php
									//if($station == '3'){
										$sql = mysql_query("select distinct customer_station, sum(loan_total_interest)due from loan_application where loan_due_date between '$filter_start_date' and '$filter_end_date' and loan_status != '10' and loan_status != '9' and loan_status != '11' and loan_status != '12' and loan_status != '14' and loan_status != '15' and loan_status != '16' and loan_status != '17' and loan_status != '18' and customer_station != '0' and loan_failure_status = '0' group by customer_station order by customer_station asc");
									...
									while ($row = mysql_fetch_array($sql))
									{
										...
										$sql2 = mysql_query("select distinct loan_code from loan_application where loan_due_date between '$filter_start_date' and '$filter_end_date' and customer_station = '$customer_station' and loan_status != '10' and loan_status != '9' and loan_status != '11' and loan_status != '12' and loan_status != '14' and loan_status != '15' and loan_status != '16' and loan_status != '17' and loan_status != '18' and loan_failure_status = '0'");
										while ($row = mysql_fetch_array($sql2))
										{
