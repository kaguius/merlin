<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "Accounts Due in the next 15 Days Report";
		include_once('includes/header.php');
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<?php
						if($station == '3'){
							 $sql = mysql_query("select loan_date, loan_due_date, customer_id, customer_station, loan_mobile, loan_code, loan_total_interest, loan_officer, collections_officer from loan_application where loan_due_date between '$current_date' and '$end_report_date' and loan_status != '13' and loan_status != '9' and loan_status != '10' and loan_status != '11' and loan_status != '12' and loan_status != '14' and loan_status != '15' order by loan_due_date asc");
							 
						}
						else{
							  $sql = mysql_query("select loan_date, loan_due_date, customer_id, customer_station, loan_mobile, loan_code, loan_total_interest, loan_officer, collections_officer from loan_application where loan_due_date between '$current_date' and '$end_report_date' and customer_station = '$station' and loan_status != '13' and loan_status != '9' and loan_status != '10' and loan_status != '11' and loan_status != '12' and loan_status != '14' and loan_status != '15' order by loan_due_date asc");
						}
