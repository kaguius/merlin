<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "CC/ FA Loans Listing";
		include_once('includes/header.php');
		$filter_clerk = 0;
		if (!empty($_GET)){	
			...
			<div id="content">
				<div class="post">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2" id="main" class="display">
						...
						$sql = mysql_query("select loan_id, loan_date, loan_due_date, loan_mobile, customer_id, customer_station, loan_status, loan_mpesa_code, loan_code, initiation_fee, loan_amount, loan_extension, loan_interest, loan_late_interest, admin_fee, appointment_fee, early_settlement, early_settlement_surplus, fix, early_settlement_surplus, loan_total_interest, waiver, edc, collections_agent from loan_application where loan_date between '$filter_start_date' and '$filter_end_date' and collections_agent != '0' and Loan_status != '13' order by loan_date asc");
