	...
	if (!empty($_POST)) {
		...
		if($page_status == 'edit'){
			if($loan_status == '5'){
				...
				$sql3="
				update loan_application set loan_mpesa_code='$loan_mpesa_code', customer_state = '$customer_state', loan_officer='$loan_officer', collections_officer='$collections_officer', comment ='$comment', loan_status='$loan_status', loan_failure_status='$loan_failure_status', admin_fee = '$admin_fee_from_form', loan_status = '$loan_status', UID='$userid', loan_interest = '$loan_interest_from_form', early_settlement='$early_settlement_from_form',  early_settlement_surplus = '$early_settlement_surplus_from_form', appointment_fee = '$appointment_fee_from_form', loan_late_interest = '$loan_late_interest_from_form', joining_fee = '$joining_fee_from_form', fix = '$fix_from_form', loan_total_interest = '$loan_total_interest', collections_agent='$collections_agent' WHERE loan_id  = '$loan_id'";
				...
				if($msg == '0'){				
					...
					if($dis_phone == $mobile_no){
						...
						VALUES('$loan_code_latest', '$user_id', '$dis_phone', '$message_text', '0', '0', '$transactiontime')";
					}
					else{
						$sql5="INSERT INTO out_msg_logs (loan_code, customer_id, mobile_no, msg_text, status, new, transactiontime) 
						VALUES('$loan_code_latest', '$user_id', '$dis_phone', '$message_text', '0', '0', '$transactiontime')";
						...
						VALUES('$loan_code_latest', '$user_id', '$mobile_no', '$message_text', '0', '0', '$transactiontime')";			
					}
				...
				if($loan_failure_status_form == '1' && $loan_status == '2' && $customer_station != '5'){
					if($mobile_carrier == 'Safaricom'){
						...
						VALUES('$loan_code_latest', '$dis_phone', '$loan_amount_from_form', '1', '0', '$customer_station', '$transactiontime')";	
					}
