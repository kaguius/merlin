<?php
	...
	if($adminstatus == 3){
		...
		$sql2 = mysql_query("select stations from stations where id = '$station'");
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<h3>Branch Name: <?php echo $customer_stations ?></h3>
						<br />
						...
						<tbody>
						<?php
						 $sql = mysql_query("select distinct lat, first_name, last_name, mobile_no, lng from users where stations = '$station' and lat != '' order by first_name asc");
