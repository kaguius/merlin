...
if ($adminstatus == 4) {
    ...
    if ($filter_start_date != "" && $filter_end_date != "") {
        ...
        $loan_amount = 0;
        $fees = 0;
        $sql = mysql_query("select loan_id, loan_code, customer_id, customer_station, loan_mobile, loan_date, loan_due_date, loan_total_interest, loan_amount, loan_interest, loan_late_interest, initiation_fee, loan_extension, waiver, admin_fee, appointment_fee, early_settlement, early_settlement_surplus, fix, joining_fee, late_status, arreardays, vintage from loan_application where late_status != 0 and loan_due_date !='' and loan_status != '13' and loan_status != '2' and loan_status != '12' and loan_status != '14' and loan_status != '11' and loan_due_date between '$filter_start_date' and '$filter_end_date' group by loan_code order by loan_due_date asc");
        ...
        while ($row = mysql_fetch_array($sql)) {
            ...
            //Fees + Interest
            //$fees = $loan_interest + $initiation_fee + $loan_extension + $waiver + $admin_fee + $appointment_fee + $early_settlement + $early_settlement_surplus + $fix + $joining_fee;
            ...
            if ($customer_station == '1') {
                ...
                if ($arreardays <= 30) {
                    $total_kawangware_outstanding_interest_30 = $total_kawangware_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_kawangware_outstanding_interest_60 = $total_kawangware_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_kawangware_outstanding_interest_90 = $total_kawangware_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_kawangware_outstanding_interest_120 = $total_kawangware_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_kawangware_outstanding_interest_121 = $total_kawangware_outstanding_interest_121 + $outstanding_principal;
                }
                ...
                if ($arreardays <= 30) {
                    $total_wangige_outstanding_interest_30 = $total_wangige_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_wangige_outstanding_interest_60 = $total_wangige_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_wangige_outstanding_interest_90 = $total_wangige_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_wangige_outstanding_interest_120 = $total_wangige_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_wangige_outstanding_interest_121 = $total_wangige_outstanding_interest_121 + $outstanding_principal;
                }
            }
            if ($customer_station == '5') {
                ...
                if ($arreardays <= 30) {
                    $total_Dagoretti_outstanding_interest_30 = $total_Dagoretti_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_Dagoretti_outstanding_interest_60 = $total_Dagoretti_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_Dagoretti_outstanding_interest_90 = $total_Dagoretti_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_Dagoretti_outstanding_interest_120 = $total_Dagoretti_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_Dagoretti_outstanding_interest_121 = $total_Dagoretti_outstanding_interest_121 + $outstanding_principal;
                }
            }
            if ($customer_station == '6') {
                ...
                if ($arreardays <= 30) {
                    $total_rongai_outstanding_interest_30 = $total_rongai_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_rongai_outstanding_interest_60 = $total_rongai_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_rongai_outstanding_interest_90 = $total_rongai_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_rongai_outstanding_interest_120 = $total_rongai_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_rongai_outstanding_interest_121 = $total_rongai_outstanding_interest_121 + $outstanding_principal;
                }
            }
            if ($customer_station == '7') {
                ...
                if ($arreardays <= 30) {
                    $total_kise_outstanding_interest_30 = $total_kise_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_kise_outstanding_interest_60 = $total_kise_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_kise_outstanding_interest_90 = $total_kise_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_kise_outstanding_interest_120 = $total_kise_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_kise_outstanding_interest_121 = $total_kise_outstanding_interest_121 + $outstanding_principal;
                }
            }
            if ($customer_station == '8') {
                ...
                if ($arreardays <= 30) {
                    $total_ngong_outstanding_interest_30 = $total_ngong_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_ngong_outstanding_interest_60 = $total_ngong_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_ngong_outstanding_interest_90 = $total_ngong_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_ngong_outstanding_interest_120 = $total_ngong_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_ngong_outstanding_interest_121 = $total_ngong_outstanding_interest_121 + $outstanding_principal;
                }
            }
            if ($customer_station == '9') {
                ...
                if ($arreardays <= 30) {
                    $total_limuru_outstanding_interest_30 = $total_limuru_outstanding_interest_30 + $outstanding_principal;
                } else if ($arreardays <= 60) {
                    $total_limuru_outstanding_interest_60 = $total_limuru_outstanding_interest_60 + $outstanding_principal;
                } else if ($arreardays <= 90) {
                    $total_limuru_outstanding_interest_90 = $total_limuru_outstanding_interest_90 + $outstanding_principal;
                } else if ($arreardays <= 120) {
                    $total_limuru_outstanding_interest_120 = $total_limuru_outstanding_interest_120 + $outstanding_principal;
                } else if ($arreardays >= 121) {
                    $total_limuru_outstanding_interest_121 = $total_limuru_outstanding_interest_121 + $outstanding_principal;
                }
            }
