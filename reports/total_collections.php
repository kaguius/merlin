<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "NPL Total Collections Report";
		include_once('includes/header.php');
		$filter_clerk = 0;
		if (!empty($_GET)){	
