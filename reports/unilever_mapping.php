<?php
	...
	if($adminstatus == 3){
		...
		$page_title = "Unilever Branch Customer Mapping";
		include_once('includes/header.php');
		?>
		<script type="text/javascript">
		    //<![CDATA[
			...
			center: new google.maps.LatLng(-1.2859495552, 36.7534437779),
			zoom: 15,
			mapTypeId: 'roadmap'
		      });
			...
			<div id="content">
				<div class="post">
					<h2><?php echo $page_title ?></h2>
						...
						<tbody>
						<?php
						 $sql = mysql_query("select first_name,last_name,mobile_no,purchase,current_loan,description,branch,lat,lng from unilever_geo_tag order by first_name asc");
						 while ($row = mysql_fetch_array($sql))
						 {
							...
							echo "<td valign='top' align='right'>" . number_format($current_loan, 2) . "</td>";
