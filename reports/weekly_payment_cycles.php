<?php
	...
	if($adminstatus == 4){
		...
		$page_title = "Weekly Cycle Customers";
		include_once('includes/header.php');
		$filter_clerk = 0;
		if (!empty($_GET)){	
		...
		<div id="page">
			<div id="content">
				<div class="post">
					...
					<?php
						if($station == '3'){
							 $sql = mysql_query("select distinct user_id, business_cycle, loan_date, loan_due_date, customer_id, customer_station, loan_mobile, loan_code, loan_total_interest, loan_officer, collections_officer from business_details inner join loan_application on loan_application.customer_id = business_details.user_id where business_cycle = 'Weekly' and loan_due_date between '$filter_start_date' and '$filter_end_date' and loan_status != '9' and loan_status != '10' and loan_status != '11' and loan_status != '12' and loan_status != '14' and loan_status != '15' order by loan_due_date asc");
						}
						else{
							  $sql = mysql_query("select distinct user_id, business_cycle, loan_date, loan_due_date, customer_id, customer_station, loan_mobile, loan_code, loan_total_interest, loan_officer, collections_officer from business_details inner join loan_application on loan_application.customer_id = business_details.user_id where business_cycle = 'Weekly' and loan_due_date between '$filter_start_date' and '$filter_end_date' and customer_station = '$station' and loan_status != '9' and loan_status != '10' and loan_status != '11' and loan_status != '12' and loan_status != '14' and loan_status != '15' order by loan_due_date asc");
						}
