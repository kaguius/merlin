						...
						<?php
							if($mobile_no != ""){
								if($station == '3'){
									...
									$sql = mysql_query("select id, title, first_name, last_name, national_id, mobile_no, marital, date_of_birth, alt_phone, stations, status, passportfileupload, resumefileupload, lat, lng from users where mobile_no = '$mobile_no' and national_id != '' and collections_agent = '$userid' order by first_name asc");
								}
								else{
								    if($title == '3' || $title == '8' || $title == '11'){  
								        $sql = mysql_query("select users.id, title, first_name, last_name, national_id, mobile_no, marital, date_of_birth, alt_phone, users.stations, status, passportfileupload, resumefileupload, lat, lng from users inner join stations on stations.id = users.stations where mobile_no = '$mobile_no' and national_id != '' and parent_branch = '$parent_branch' order by first_name asc");
								    }
								    else{
								        $sql = mysql_query("select id, title, first_name, last_name, national_id, mobile_no, marital, date_of_birth, alt_phone, stations, status, passportfileupload, resumefileupload, lat, lng from users where mobile_no = '$mobile_no' and national_id != '' and stations = '$station' order by first_name asc");
								    }
								}	
							}
							else if($id_number != ""){
								if($station == '3'){
									...
									$sql = mysql_query("select id, title, first_name, last_name, national_id, mobile_no, marital, date_of_birth, alt_phone, stations, status, passportfileupload, resumefileupload, lat, lng from users where national_id = '$id_number' and collections_agent = '$userid' and national_id != '' order by first_name asc");
								}
								else{
									if($title == '3' || $title == '8' || $title == '11'){  
								        $sql = mysql_query("select users.id, title, first_name, last_name, national_id, mobile_no, marital, date_of_birth, alt_phone, users.stations, status, passportfileupload, resumefileupload, lat, lng from users inner join stations on stations.id = users.stations where national_id = '$id_number' and national_id != '' and parent_branch = '$parent_branch' order by first_name asc");
								    }
								    else{
								        $sql = mysql_query("select id, title, first_name, last_name, national_id, mobile_no, marital, date_of_birth, alt_phone, stations, status, passportfileupload, resumefileupload, lat, lng from users where national_id = '$id_number' and national_id != '' and stations = '$station' order by first_name asc");
								    }
								}
							}
							...
							while ($row = mysql_fetch_array($sql))
							 {
                                ...
                                echo "<td valign='top' align='center'><a href='customer_loans.php?user_id=$id'><img src='images/loans_icon.png' width='25px'></a></td>";
                                echo "<td valign='top' align='center'><a href='business_details.php?user_id=$id&mode=edit'><img src='images/folder-horizontal.png' width='35px'></a></td>";
                                echo "<td valign='top' align='center'><a href='map.php?user_id=$id&mode=edit'><img src='images/markers.png' width='35px'></a></td>";
								echo "<td valign='top'>$issues</td>";
								echo "<td valign='top' align='center'><a href='complaints.php?user_id=$id&mode=edit'><img src='images/complaints.png' width='45px'></a></td>";
